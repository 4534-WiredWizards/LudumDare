...
public class Player extends GameObject {
    ...
    public void update(float delta) {
        vSpeed = 200 + LD34Main.gameTime * 4f;
    ...
    public void render(SpriteBatch batch, float delta) {
        ...
        TitleScreen.Companion.getFont().draw(batch, String.valueOf((int) (LD34Main.gameTime / 10f)), -camera.viewportWidth / 2f + 2, camera.position.y - camera.viewportHeight / 2f + TitleScreen.Companion.getFont().getCapHeight());
    }
